...
class GameTest {
    ...
    void sortPlayers() {
        Game game = new Game(new Player[]{new Player(1, new Hand()), new Player(2, new Hand())});
        game.init();
        game.getPlayers()[0].getCity().add(new Construction("Temple", Color.RELIGIEUX, 1));
        game.getPlayers()[0].getCity().add(new Construction("Forteresse", Color.SOLDATESQUE, 5));
        game.getPlayers()[1].getCity().add(new Construction("Temple", Color.RELIGIEUX, 1));
        game.getPlayers()[1].getCity().add(new Construction("Forteresse", Color.SOLDATESQUE, 2));
    ...
    void playerHasFinished() {
        ...
        game.getPlayers()[0].getCity().add(new Construction("Temple", Color.RELIGIEUX, 1));
        game.getPlayers()[0].getCity().add(new Construction("Temple", Color.RELIGIEUX, 1));
        game.getPlayers()[1].getCity().add(new Construction("Forteresse", Color.SOLDATESQUE, 5));
        game.getPlayers()[1].getCity().add(new Construction("Forteresse", Color.SOLDATESQUE, 5));
        game.getPlayers()[1].getCity().add(new Construction("Forteresse", Color.SOLDATESQUE, 5));
        game.getPlayers()[1].getCity().add(new Construction("Forteresse", Color.SOLDATESQUE, 5));
        game.getPlayers()[1].getCity().add(new Construction("Forteresse", Color.SOLDATESQUE, 5));
